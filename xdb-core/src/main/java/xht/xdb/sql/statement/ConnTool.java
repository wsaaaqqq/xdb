package xht.xdb.sql.statement;

import xht.xdb.Xdb;
import xht.xdb.sql.ResultBatch;
import xht.xdb.sql.ResultQuery;
import xht.xdb.sql.ResultUpdate;
import xht.xdb.util.Closes;
import xht.xdb.util.MapUtil;
import xht.xdb.util.ResultSetUtil;
